...
def drawPolygon(_SCREENcolor, turtle, _PENcolor, _SHAPEcolor, _NUMsides, _LENGTHsides,  ):
    '''This function will take variables and actually draw the function'''
    wn = turtle.Screen()
...
def main():
    ...
    drawPolygon(_SCREENcolor, turtle, _PENcolor, _SHAPEcolor,_NUMsides, _LENGTHsides, )
